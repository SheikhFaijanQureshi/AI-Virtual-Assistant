...
function takeCommand(message){
   voice.style.display="none"
    ...
    if(message.includes("hello")||message.includes("hey")){
        ...
        speak("i am virtual assistant ,created by Faijaan Sir")
    }
      ...
      speak(time)
        ...
        let finalText="this is what i found on internet regarding" + message.replace("sheikh","") || message.replace("sheikh","")
        speak(finalText)
        window.open(`https://www.google.com/search?q=${message.replace("sheikh","")}`,"_blank")
    }
}
// Scroll Reval
ScrollReveal({ 
